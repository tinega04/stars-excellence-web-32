    ...
    <div className="min-h-screen">
      ...
      <main className="container py-10 md:py-16 animate-fade-in">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-16">
            <div className="bg-navy/5 p-10 rounded-lg shadow-inner relative overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-full bg-gold"></div>
              <h2 className="text-3xl font-playfair text-navy mb-6 text-center">Vision</h2>
          ...
          <section className="mb-16">
            <div className="bg-navy/5 p-10 rounded-lg shadow-inner relative overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-full bg-gold"></div>
              <h2 className="text-3xl font-playfair text-navy mb-6 text-center">Mission</h2>
              <p className="text-lg text-gray-700 text-center italic">
          ...
          <section className="mb-16">
            <div className="bg-navy/5 p-10 rounded-lg shadow-inner relative overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-full bg-gold"></div>
              <h2 className="text-3xl font-playfair text-navy mb-6 text-center">Belief</h2>
              <p className="text-lg text-gray-700 text-center italic">
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-playfair text-navy mb-10 text-center">Visit Our Campuses</h2>
