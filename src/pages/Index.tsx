...
const Index = () => {
  ...
  return <div className="min-h-screen">
      ...
      <section className="relative h-[90vh] min-h-[600px] bg-darkBlue overflow-hidden">
        <div className="absolute inset-0 z-10">
          <div className="relative h-full w-full overflow-hidden">
            {slides.map((slide, index) => <div key={index} className={`absolute inset-0 transition-opacity duration-1000 ease-in-out ${activeSlide === index ? "opacity-100 z-20" : "opacity-0 z-10"}`}>
                <div className="absolute inset-0 bg-gradient-to-r from-darkBlue/80 to-darkBlue/60 z-10"></div>
                <img src={slide.image} alt={slide.title} className="absolute inset-0 w-full h-full object-cover" />
                <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-20 px-4 sm:px-6 md:px-8">
                  <h1 className="font-playfair text-3xl sm:text-4xl md:text-5xl text-center mb-4 sm:mb-6 animate-fade-in text-white font-bold lg:text-6xl max-w-4xl">
                    {slide.title}
                  </h1>
                  <p className="text-lg sm:text-xl md:text-2xl text-center mb-6 sm:mb-8 max-w-2xl animate-fade-in text-white/90 font-medium px-4 sm:px-0">
                    {slide.subtitle}
                  </p>
                  <Link to={slide.link} className="bg-accentBlue hover:bg-white hover:text-accentBlue text-white px-6 sm:px-8 py-3 sm:py-4 rounded-md flex items-center gap-2 transition-all duration-300 animate-fade-in font-semibold text-base sm:text-lg shadow-lg hover:shadow-xl">
                    {slide.cta}
                    <ArrowRight size={20} />
                  </Link>
                </div>
        ...
        <div className="absolute bottom-6 sm:bottom-10 left-0 right-0 z-30 flex justify-center">
          <div className="flex space-x-2 sm:space-x-3">
            {slides.map((_, index) => <button key={index} onClick={() => setSlide(index)} className={`w-2 sm:w-3 h-2 sm:h-3 rounded-full transition-all ${activeSlide === index ? 'bg-accentBlue w-8 sm:w-10' : 'bg-white hover:bg-white/90'}`} aria-label={`Go to slide ${index + 1}`}></button>)}
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-white">
        <div className="container px-4 sm:px-6 md:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-darkBlue max-w-2xl mx-auto mt-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="group card-premium">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="font-playfair text-xl sm:text-2xl text-darkBlue mb-2">Nairobi Campus</h3>
                <p className="text-textGray mb-4 leading-relaxed text-sm sm:text-base">
            ...
            <div className="group card-premium">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="font-playfair text-xl sm:text-2xl text-darkBlue mb-2">Kitengela Campus</h3>
                <p className="text-textGray mb-4 leading-relaxed text-sm sm:text-base">
      ...
      <section className="section-padding bg-white">
        <div className="container px-4 sm:px-6 md:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-textGray max-w-3xl mx-auto mt-4">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {/* Kindergarten */}
            <div className="bg-white rounded-lg p-6 sm:p-8 shadow-md text-center hover:shadow-lg transition-shadow duration-300">
              <div className="w-16 sm:w-20 h-16 sm:h-20 bg-accentBlue/10 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <img src="https://images.unsplash.com/photo-1605810230434-7631ac76ec81?auto=format&fit=crop&w=80&h=80" alt="Kindergarten icon" className="w-10 sm:w-12 h-10 sm:h-12 object-contain" />
              </div>
              <h3 className="font-playfair text-lg sm:text-xl text-darkBlue mb-3 sm:mb-4">Kindergarten</h3>
              <p className="text-textGray mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
            ...
            <div className="bg-white rounded-lg p-6 sm:p-8 shadow-md text-center hover:shadow-lg transition-shadow duration-300">
              <div className="w-16 sm:w-20 h-16 sm:h-20 bg-accentBlue/10 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=80&h=80" alt="Primary icon" className="w-10 sm:w-12 h-10 sm:h-12 object-contain" />
              </div>
              <h3 className="font-playfair text-lg sm:text-xl text-darkBlue mb-3 sm:mb-4">Primary</h3>
              <p className="text-textGray mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
            ...
            <div className="bg-white rounded-lg p-6 sm:p-8 shadow-md text-center hover:shadow-lg transition-shadow duration-300">
              <div className="w-16 sm:w-20 h-16 sm:h-20 bg-accentBlue/10 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <img src="https://images.unsplash.com/photo-1501854140801-50d01698950b?auto=format&fit=crop&w=80&h=80" alt="Junior School icon" className="w-10 sm:w-12 h-10 sm:h-12 object-contain" />
              </div>
              <h3 className="font-playfair text-lg sm:text-xl text-darkBlue mb-3 sm:mb-4">Junior School</h3>
              <p className="text-textGray mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
          ...
          <div className="bg-white p-6 sm:p-8 md:p-12 rounded-lg shadow-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              ...
              <div className="flex flex-col items-center text-center group">
                <div className="w-16 sm:w-16 h-16 sm:h-16 bg-accentBlue/10 rounded-full flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-accentBlue/20 transition-colors duration-300">
                ...
                <h3 className="font-playfair text-base sm:text-lg text-darkBlue mb-2 sm:mb-3">CBC-Aligned</h3>
                <p className="text-textGray leading-relaxed text-sm sm:text-base">
              ...
              <div className="flex flex-col items-center text-center group">
                ...
                <h3 className="font-playfair text-base sm:text-lg text-darkBlue mb-2 sm:mb-3">Safe Environment</h3>
                <p className="text-textGray leading-relaxed text-sm sm:text-base">
              ...
              <div className="flex flex-col items-center text-center group">
                ...
                <h3 className="font-playfair text-base sm:text-lg text-darkBlue mb-2 sm:mb-3">Qualified Staff</h3>
                <p className="text-textGray leading-relaxed text-sm sm:text-base">
              ...
              <div className="flex flex-col items-center text-center group">
                ...
                <h3 className="font-playfair text-base sm:text-lg text-darkBlue mb-2 sm:mb-3">Co-curricular Activities</h3>
                <p className="text-textGray leading-relaxed text-sm sm:text-base">
        ...
        <div className="container">
          ...
          <Carousel className="max-w-5xl mx-auto" opts={{ align: "start", loop: true }}>
              ...
              <CarouselItem className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                <div className="bg-white rounded-lg shadow-md overflow-hidden h-full">
                  ...
                  <div className="p-6">
                    ...
                    <Link to="/events" className="flex items-center text-accentBlue font-medium hover:text-accentBlue-600 transition duration-300 group">
            ...
            <div className="hidden md:flex justify-end gap-2 mt-4">
              <CarouselPrevious className="bg-darkBlue text-white hover:bg-darkBlue-600 border-0 static translate-x-0 translate-y-0 mr-2" />
              <CarouselNext className="bg-darkBlue text-white hover:bg-darkBlue-600 border-0 static translate-x-0 translate-y-0" />
            </div>
          </Carousel>
        </div>
      </section>
      ...
      <section className="section-padding bg-darkBlue text-white relative overflow-hidden border-b-8 border-accentBlue">
        <div className="absolute inset-0 bg-darkBlue/80 z-10"></div>
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1501504905252-473c47e087f8?auto=format&fit=crop&w=1600&h=900" alt="School background" className="w-full h-full object-cover opacity-30" />
        </div>
        <div className="container relative z-20 text-center">
          <h2 className="font-playfair text-3xl md:text-4xl mb-6 max-w-3xl mx-auto text-white font-bold lg:text-5xl">
          ...
          <Link to="/admissions" className="bg-accentBlue hover:bg-white text-white hover:text-darkBlue transition-all duration-300 px-8 py-4 rounded-md inline-flex items-center font-semibold text-lg shadow-lg hover:shadow-xl">
            Apply Now
          </Link>
        </div>
      </section>
